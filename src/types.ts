...
import * as Admin from "@buf/meshtastic_protobufs.bufbuild_es/meshtastic/admin_pb.js";
// import * as cannedmessages_pb_js from "@buf/meshtastic_protobufs.bufbuild_es/meshtastic/cannedmessages_pb.js";
// biome-ignore lint/style/useImportType: <explanation>
import * as Channel from "@buf/meshtastic_protobufs.bufbuild_es/meshtastic/channel_pb.js";
...
export interface CatalogInitialDefinition {
	id: string;
	metadata: CatalogMetadata;
	config?: DeepPartial<Config>;
	modules?: DeepPartial<ModuleConfig>;
	channels?: DeepPartial<ChannelDefinition>[];
}

export interface CatalogDefinition {
	id: string;
	metadata: CatalogMetadata;
	config?: DeepPartial<LocalOnly.LocalConfig>;
	modules?: DeepPartial<LocalOnly.LocalModuleConfig>;
	channels?: DeepPartial<Channel.Channel>[];
}
